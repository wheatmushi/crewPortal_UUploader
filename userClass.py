...
class User:  # creation/deletion user methods and checking data routine while __init__
    ...
    def check(self, session):
        url_check = 'https://su-ati.crewplatform.aero/CrewServices/crewManager/v1/SU/'
        try:
    ...
    def create(self, session):
        url_upl = 'https://su-ati.crewplatform.aero/CrewServices/crewManager/user/SU'
    ...
    def delete(self, session):
        url = 'https://su-ati.crewplatform.aero/CrewServices/crewManager/delete/SU/'
